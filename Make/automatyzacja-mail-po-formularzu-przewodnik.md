...
Formularz robimy w dwóch częściach: **Część 1** — funkcja tworząca formularz (tu masz dwa warianty: gotowy kod albo generowanie przez AI), **Część 2** — uniwersalna funkcja `onFormSubmit`, na której oba warianty się spotykają.
